...
public class FDArticlelink_API4 extends ProjectMethods {
	...
	public FDArticlelink_API4(ExtentTest test) {
		this.test=test;
	}

	public FDArticlelink_API4 Articleapi(String api) {
		try {
	...
	public FDArticlelink_API4 articlelink() throws ClientProtocolException, IOException, URISyntaxException {
	...
	public FDArticlelink_API4 api(String api) {
		try {
			CloseableHttpResponse response= GETJSON(api);
			HttpEntity ent=response.getEntity();
			if(ent!=null) 
	...
	public FDArticlelink_API4 Article_getvalues() {
	...
	public FDArticlelink_API4 commonkeys() {
		try {
	...
	public FDArticlelink_API4 heroimage() {
	...
	public FDArticlelink_API4 author() {
	...
	public FDArticlelink_API4 Thumbnail() {
	...
	public FDArticlelink_API4 Potraitthumbnail() {
		JSONObject Bodykeyvalue=new JSONObject(result).getJSONObject("body");
		JSONObject article= Bodykeyvalue.getJSONObject("featuredContent");
		JSONObject articleItem = article.getJSONObject("article");
	...
	public FDArticlelink_API4 Categories() {
	...
	public FDArticlelink_API4 Segments() {
	...
	public FDArticlelink_API4 Segments_Objects(String Objects,int i) {
		try {
	...
	public JSONArray seg() {
		
		JSONObject Bodykeyvalue=new JSONObject(result).getJSONObject("body");
		JSONObject article= Bodykeyvalue.getJSONObject("featuredContent");
		JSONObject articleItem = article.getJSONObject("article");
		JSONArray Segmentsname=articleItem.getJSONArray("segments");
		JSONArray S=new JSONArray(Segmentsname);
		return S;
		
	}

	public FDArticlelink_API4 video(int i,JSONArray S) {
		JSONArray Array=new JSONArray(S);
		int segmentkey=Array.length();
			JSONObject Keyvalue_segments=(JSONObject) Array.get(i);
	...
	public FDArticlelink_API4 Video_Thumbnail(int i) {
		JSONObject Bodykeyvalue=new JSONObject(result).getJSONObject("body");
		JSONObject article= Bodykeyvalue.getJSONObject("featuredContent");
		JSONObject articleItem = article.getJSONObject("article");
		JSONArray Segmentsname=articleItem.getJSONArray("segments");
	...
	public FDArticlelink_API4 Segments_Phototext(int i) {
		JSONObject Bodykeyvalue=new JSONObject(result).getJSONObject("body");
		JSONObject article= Bodykeyvalue.getJSONObject("featuredContent");
		JSONObject articleItem = article.getJSONObject("article");
		JSONArray Segmentsname=articleItem.getJSONArray("segments");
	...
	public FDArticlelink_API4 Segments_Thumbnail(int i) {
		JSONObject Bodykeyvalue=new JSONObject(result).getJSONObject("body");
		JSONObject article= Bodykeyvalue.getJSONObject("featuredContent");
		JSONObject articleItem = article.getJSONObject("article");
		JSONArray Segmentsname=articleItem.getJSONArray("segments");
	...
	public FDArticlelink_API4 Verticalgallery(int i) {
	...
	public FDArticlelink_API4 VG_GalleryItems(int i) {
	...
	public FDArticlelink_API4 eCommerce(int i) {
		JSONObject Bodykeyvalue=new JSONObject(result).getJSONObject("body");
		JSONObject article= Bodykeyvalue.getJSONObject("featuredContent");
		JSONObject articleItem = article.getJSONObject("article");
		JSONArray Segmentsname=articleItem.getJSONArray("segments");
	...
	public FDArticlelink_API4 eCommerceThumbnail(int i) {
		JSONObject Bodykeyvalue=new JSONObject(result).getJSONObject("body");
		JSONObject article= Bodykeyvalue.getJSONObject("featuredContent");
		JSONObject articleItem = article.getJSONObject("article");
		JSONArray Segmentsname=articleItem.getJSONArray("segments");
	...
	public FDArticlelink_API4 eCommerceOffers(int i) {
		JSONObject Bodykeyvalue=new JSONObject(result).getJSONObject("body");
		JSONObject article= Bodykeyvalue.getJSONObject("featuredContent");
		JSONObject articleItem = article.getJSONObject("article");
		JSONArray Segmentsname=articleItem.getJSONArray("segments");
