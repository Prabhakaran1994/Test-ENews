...
public class FDArticlelink_API2 extends ProjectMethods {
	...
	public FDArticlelink_API2(ExtentTest test) {
		this.test=test;
	}

	public FDArticlelink_API2 Articleapi(String api) {
		try {
	...
	public FDArticlelink_API2 articlelink() throws ClientProtocolException, IOException, URISyntaxException {
	...
	public FDArticlelink_API2 api(String api) {
		try {
			CloseableHttpResponse response= GETJSON(api);
			HttpEntity ent=response.getEntity();
			if(ent!=null) 
	...
	public FDArticlelink_API2 Article_getvalues() {
	...
	public FDArticlelink_API2 commonkeys() {
		try {
	...
	public FDArticlelink_API2 heroimage() {
	...
	public FDArticlelink_API2 author() {
	...
	public FDArticlelink_API2 Thumbnail() {
	...
	public FDArticlelink_API2 Potraitthumbnail() {
		JSONObject Bodykeyvalue=new JSONObject(result).getJSONObject("body");
		JSONObject article= Bodykeyvalue.getJSONObject("featuredContent");
		JSONObject articleItem = article.getJSONObject("article");
	...
	public FDArticlelink_API2 Categories() {
	...
	public FDArticlelink_API2 Segments() {
						...
						if(Currentdynamickey.equalsIgnoreCase(Segmentskeyname.get(j))) {
							if(!Keyvalue_segments.getString(Currentdynamickey).isEmpty()) {
								if(!Keyvalue_segments.getString(Currentdynamickey).equalsIgnoreCase("null")) {
									...
									Segments_Objects(Keyvalue_segments.getString(Currentdynamickey));
								}
								else {
	...
	public FDArticlelink_API2 Segments_Objects(String Objects) {
		try {
	...
	public FDArticlelink_API2 video() {
		JSONObject Bodykeyvalue=new JSONObject(result).getJSONObject("body");
		JSONObject article= Bodykeyvalue.getJSONObject("featuredContent");
		JSONObject articleItem = article.getJSONObject("article");
		JSONArray Segmentsname=articleItem.getJSONArray("segments");
	...
	public FDArticlelink_API2 Video_Thumbnail() {
		JSONObject Bodykeyvalue=new JSONObject(result).getJSONObject("body");
		JSONObject article= Bodykeyvalue.getJSONObject("featuredContent");
		JSONObject articleItem = article.getJSONObject("article");
		JSONArray Segmentsname=articleItem.getJSONArray("segments");
	...
	public FDArticlelink_API2 Segments_Phototext() {
		JSONObject Bodykeyvalue=new JSONObject(result).getJSONObject("body");
		JSONObject article= Bodykeyvalue.getJSONObject("featuredContent");
		JSONObject articleItem = article.getJSONObject("article");
		JSONArray Segmentsname=articleItem.getJSONArray("segments");
	...
	public FDArticlelink_API2 Segments_Thumbnail() {
		JSONObject Bodykeyvalue=new JSONObject(result).getJSONObject("body");
		JSONObject article= Bodykeyvalue.getJSONObject("featuredContent");
		JSONObject articleItem = article.getJSONObject("article");
		JSONArray Segmentsname=articleItem.getJSONArray("segments");
	...
	public FDArticlelink_API2 Verticalgallery() {
	...
	public FDArticlelink_API2 VG_GalleryItems() {
	...
	public FDArticlelink_API2 eCommerce() {
		JSONObject Bodykeyvalue=new JSONObject(result).getJSONObject("body");
		JSONObject article= Bodykeyvalue.getJSONObject("featuredContent");
		JSONObject articleItem = article.getJSONObject("article");
		JSONArray Segmentsname=articleItem.getJSONArray("segments");
	...
	public FDArticlelink_API2 eCommerceThumbnail() {
		JSONObject Bodykeyvalue=new JSONObject(result).getJSONObject("body");
		JSONObject article= Bodykeyvalue.getJSONObject("featuredContent");
		JSONObject articleItem = article.getJSONObject("article");
		JSONArray Segmentsname=articleItem.getJSONArray("segments");
	...
	public FDArticlelink_API2 eCommerceOffers() {
		JSONObject Bodykeyvalue=new JSONObject(result).getJSONObject("body");
		JSONObject article= Bodykeyvalue.getJSONObject("featuredContent");
		JSONObject articleItem = article.getJSONObject("article");
		JSONArray Segmentsname=articleItem.getJSONArray("segments");
